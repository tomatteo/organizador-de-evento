...
class InterfaceGrafica(tk.Tk):
    def __init__(self):
        ...
        # Estilo dos Dropdowns e Spinboxes
    ...
    def cadastrar_evento(self):
        ...
        # Função NOVA para criar seletores de Data e Hora amigáveis
        def criar_seletor_data_hora(texto):
            ...
            sb_hora.set("19") # Hora padrão sugestiva
        ...
        # Usando os novos seletores em vez de digitar texto
