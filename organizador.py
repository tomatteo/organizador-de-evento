...
class Organizador(Usuario):
    ...
    def criarEvento(self, id: int, nome: str, desc: str, dt_inicio, dt_fim, cap: int, local_info: dict) -> Union[Evento, None]: # Corrigido para Union
        ...
        # A classe Evento lida com o datetime internamente, não precisa importar aqui.
        novo_evento = Evento(
